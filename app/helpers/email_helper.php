    ...
    function get_email_config() {
        ...
        try {
            ...
            return [
                ...
                'charset' => 'utf-8',
                'wordwrap' => TRUE,
                'from_email' => !empty($settings['from_email']) ? $settings['from_email'] : ($settings['smtp_user'] ?? 'ascanlindon@gmail.com'),
                'from_name' => $settings['from_name'] ?? 'CraftsHub'
            ];
            ...
            return [
                ...
                'smtp_host' => 'smtp.gmail.com',
                'smtp_port' => '587',
                'smtp_user' => 'ascanlindon@gmail.com',
                'smtp_pass' => 'bswy dyis tryp axfe',
                'smtp_crypto' => 'tls',
                'mailtype' => 'html',
                'charset' => 'utf-8',
                'wordwrap' => TRUE,
